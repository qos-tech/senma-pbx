...
# File References
nextStepFile: '{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/steps-c/step-12-complete.md'
outputFile: '{docs_dir}/prd.md'
purposeFile: '{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/data/prd-purpose.md'
...
After user selects 'C' and polished document is saved, load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/steps-c/step-12-complete.md` to complete the workflow.
