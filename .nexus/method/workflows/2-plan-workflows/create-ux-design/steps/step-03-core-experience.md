...
- IF C: Load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-ux-design/steps/step-04-emotional-response.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-ux-design/steps/step-04-emotional-response.md` to define desired emotional responses.
