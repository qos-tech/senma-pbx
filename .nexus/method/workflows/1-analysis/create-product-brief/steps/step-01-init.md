...
# File References
nextStepFile: '{project-root}/.nexus/method/workflows/1-analysis/create-product-brief/steps/step-02-vision.md'
...
- **STOP immediately** and load `{project-root}/.nexus/method/workflows/1-analysis/create-product-brief/steps/step-01b-continue.md`
