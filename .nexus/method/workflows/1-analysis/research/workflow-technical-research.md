...
- `project_name`, `output_folder`, `user_name` (planning artifacts live in `{docs_dir}`, assigned by the runner)
...
4. Create the starter output file: `{docs_dir}/technical-research.md` with exact copy of the `./research.template.md` contents
