...
- Load: `{project-root}/.nexus/method/workflows/1-analysis/research/technical-steps/step-05-implementation-research.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.nexus/method/workflows/1-analysis/research/technical-steps/step-05-implementation-research.md` to focus on implementation approaches and technology adoption.
