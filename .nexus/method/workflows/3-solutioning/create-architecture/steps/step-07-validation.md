...
- Read fully and follow: {project-root}/.nexus/method/core/workflows/advanced-elicitation/workflow.md with validation issues
...
- Read fully and follow: {project-root}/.nexus/method/core/workflows/party-mode/workflow.md with validation context
...
- Load `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-08-complete.md`
...
Write content to file immediately after generation. Load `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-08-complete.md` to complete the workflow and provide implementation guidance.
