...
1. `{docs_dir}/*prd*.md` (whole document)
2. `{docs_dir}/*prd*/index.md` (sharded version)

**Architecture Document Search Priority:**

1. `{docs_dir}/*architecture*.md` (whole document)
2. `{docs_dir}/*architecture*/index.md` (sharded version)

**UX Design Document Search (Optional):**

1. `{docs_dir}/*ux*.md` (whole document)
2. `{docs_dir}/*ux*/index.md` (sharded version)
