...
- Load: `{project-root}/.nexus/method/workflows/1-analysis/research/domain-steps/step-05-technical-trends.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.nexus/method/workflows/1-analysis/research/domain-steps/step-05-technical-trends.md` to analyze technical trends and innovations in the domain.
