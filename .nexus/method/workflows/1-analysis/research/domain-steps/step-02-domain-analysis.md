...
- Load: `{project-root}/.nexus/method/workflows/1-analysis/research/domain-steps/step-03-competitive-landscape.md`
...
After user selects 'C', load `{project-root}/.nexus/method/workflows/1-analysis/research/domain-steps/step-03-competitive-landscape.md` to analyze competitive landscape, key players, and ecosystem analysis for {{research_topic}}.
