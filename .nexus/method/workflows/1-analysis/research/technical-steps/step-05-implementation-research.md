...
- Load: `{project-root}/.nexus/method/workflows/1-analysis/research/technical-steps/step-06-research-synthesis.md`
...
After user selects 'C', load `{project-root}/.nexus/method/workflows/1-analysis/research/technical-steps/step-06-research-synthesis.md` to produce the comprehensive technical research document with narrative introduction, detailed TOC, and executive summary.
