...
- Load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/steps-c/step-03-success.md`, read its frontmatter
- Read fully and follow: `{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/steps-c/step-04-journeys.md`
