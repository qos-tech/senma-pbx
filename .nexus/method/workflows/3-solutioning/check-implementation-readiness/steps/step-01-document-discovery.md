...
outputFile: '{docs_dir}/implementation-readiness-report.md'
...
- Whole: `{docs_dir}/*prd*.md`
- Sharded: `{docs_dir}/*prd*/index.md` and related files

#### B. Architecture Documents

- Whole: `{docs_dir}/*architecture*.md`
- Sharded: `{docs_dir}/*architecture*/index.md` and related files

#### C. Epics & Stories Documents

- Whole: `{docs_dir}/*epic*.md`
- Sharded: `{docs_dir}/*epic*/index.md` and related files

#### D. UX Design Documents

- Whole: `{docs_dir}/*ux*.md`
- Sharded: `{docs_dir}/*ux*/index.md` and related files
