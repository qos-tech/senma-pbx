...
- Read fully and follow: {project-root}/.nexus/method/core/workflows/advanced-elicitation/workflow.md with current project structure
...
- Read fully and follow: {project-root}/.nexus/method/core/workflows/party-mode/workflow.md with project structure context
...
- Load `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-07-validation.md`
...
Write content to file immediately after generation. Load `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-07-validation.md` to validate architectural coherence and completeness.
