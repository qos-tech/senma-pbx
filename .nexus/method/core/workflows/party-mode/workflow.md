...
- Agent roster: every `{project-root}/.nexus/method/agents/*.agent.yaml`

### Paths

- `installed_path` = `{project-root}/.nexus/method/core/workflows/party-mode`
- `agent_roster_glob` = `{project-root}/.nexus/method/agents/*.agent.yaml`
