...
- Load: `{project-root}/.nexus/method/workflows/1-analysis/research/domain-steps/step-04-regulatory-focus.md`
...
After user selects 'C', load `{project-root}/.nexus/method/workflows/1-analysis/research/domain-steps/step-04-regulatory-focus.md` to analyze regulatory requirements, compliance frameworks, and legal considerations for {{research_topic}}.
