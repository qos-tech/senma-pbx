...
- Load: `{project-root}/.nexus/method/workflows/1-analysis/research/market-steps/step-05-competitive-analysis.md`
...
After user selects 'C', load `{project-root}/.nexus/method/workflows/1-analysis/research/market-steps/step-05-competitive-analysis.md` to analyze competitive landscape, market positioning, and competitive strategies for {{research_topic}}.
