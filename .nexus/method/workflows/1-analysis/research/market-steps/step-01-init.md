...
- Load: `{project-root}/.nexus/method/workflows/1-analysis/research/market-steps/step-02-customer-behavior.md`
...
After user confirmation and scope finalization, load `{project-root}/.nexus/method/workflows/1-analysis/research/market-steps/step-02-customer-behavior.md` to begin detailed market research with customer insights analysis.
