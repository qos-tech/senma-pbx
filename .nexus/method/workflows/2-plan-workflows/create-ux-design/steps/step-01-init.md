...
- Look for file at `{docs_dir}/*ux*.md`
...
- **STOP here** and load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-ux-design/steps/step-01b-continue.md` immediately
...
Copy the template from `{installed_path}/ux-design-template.md` to `{docs_dir}/ux.md`
...
- Created: `{docs_dir}/ux.md` from template
...
After user selects [C] to continue, ensure the file `{docs_dir}/ux.md` has been created and saved, and then load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-ux-design/steps/step-02-discovery.md` to begin the UX discovery phase.
