...
# File References
nextStepFile: '{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/steps-c/step-07-project-type.md'
outputFile: '{docs_dir}/prd.md'

# Data Files
projectTypesCSV: '{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/data/project-types.csv'
