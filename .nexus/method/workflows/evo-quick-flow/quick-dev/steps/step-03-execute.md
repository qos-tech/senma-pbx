...
When ALL tasks are complete (or halted on blocker), read fully and follow: `{project-root}/.nexus/method/workflows/evo-quick-flow/quick-dev/steps/step-04-self-check.md`.
