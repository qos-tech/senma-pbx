...
- If `lastStep = 1` → Load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-ux-design/steps/step-02-discovery.md`
- If `lastStep = 2` → Load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-ux-design/steps/step-03-core-experience.md`
- If `lastStep = 3` → Load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-ux-design/steps/step-04-emotional-response.md`
