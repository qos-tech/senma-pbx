...
- If `lastStep = 1` → Load `{project-root}/.nexus/method/workflows/1-analysis/create-product-brief/steps/step-02-vision.md`
- If `lastStep = 2` → Load `{project-root}/.nexus/method/workflows/1-analysis/create-product-brief/steps/step-03-users.md`
- If `lastStep = 3` → Load `{project-root}/.nexus/method/workflows/1-analysis/create-product-brief/steps/step-04-metrics.md`
