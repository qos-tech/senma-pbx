...
- **Workflow variables**: From workflow.md (specs_dir, docs_dir, epics_file, active_issue, etc.)
...
4. **Resolve all workflow variables**: specs_dir, docs_dir, epics_file, architecture_file, active_issue, etc.
