...
- When 'A' selected: Execute {project-root}/.nexus/method/core/workflows/advanced-elicitation/workflow.md
- When 'P' selected: Execute {project-root}/.nexus/method/core/workflows/party-mode
...
- Execute {project-root}/.nexus/method/core/workflows/advanced-elicitation/workflow.md with current category rules
...
Write content to file immediately after generation for each category. Load `{project-root}/.nexus/method/workflows/generate-project-context/steps/step-03-complete.md` to finalize the project context file after all categories are complete.
