...
addAction = function(action_spec) {
    ...
    caption = "<a class='removeButton' href='#' onclick=\"removeAction($('" + action_spec.id + "')); return false;\"><img src='" + (typeof SNEP_BASEURL !== 'undefined' ? SNEP_BASEURL : '') + "/images/remover.png'></a>" + caption;
