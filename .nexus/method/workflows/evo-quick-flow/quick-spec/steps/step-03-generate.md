...
- A task must be something YOU can finish. Writing a file and listing it on the
  issue is a task; opening, previewing or "checking the visual reading" of it
  is not, because the app is what displays what you produced.
...
- Manual testing steps, meaning steps a PERSON takes. Never a step that asks
  you to open, preview or view a file you produced: a mock under
  `.nexus/assets/` is rendered inside the app, so "open it in the browser and
  check it" describes a workflow this method does not have, and you would be
  writing a task you cannot honestly tick.
...
c) **Read fully and follow: `{project-root}/.nexus/method/workflows/evo-quick-flow/quick-spec/steps/step-04-review.md` (Step 4)**
