...
# File References
nextStepFile: '{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/steps-c/step-04-journeys.md'
...
After user selects 'C' and content is saved to document, load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/steps-c/step-04-journeys.md` to map user journeys.
