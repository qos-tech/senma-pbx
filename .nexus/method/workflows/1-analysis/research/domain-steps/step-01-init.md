...
- Load: `{project-root}/.nexus/method/workflows/1-analysis/research/domain-steps/step-02-domain-analysis.md`
...
After user selects 'C', load `{project-root}/.nexus/method/workflows/1-analysis/research/domain-steps/step-02-domain-analysis.md` to begin industry analysis.
