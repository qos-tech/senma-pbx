...
```
<!-- Generated by /qos:context. Manual edits are overwritten on re-run. -->
```
...
grep -Fq '<!-- Generated by /qos:context.' <path>    # ownership banner
