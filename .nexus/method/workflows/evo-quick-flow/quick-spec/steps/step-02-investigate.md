...
- IF C: Verify frontmatter updated with `stepsCompleted: [1, 2]`, then read fully and follow: `{project-root}/.nexus/method/workflows/evo-quick-flow/quick-spec/steps/step-03-generate.md`
