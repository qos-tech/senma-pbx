...
With findings in hand, read fully and follow: `{project-root}/.nexus/method/workflows/evo-quick-flow/quick-dev/steps/step-06-resolve-findings.md` for user to choose resolution approach.
