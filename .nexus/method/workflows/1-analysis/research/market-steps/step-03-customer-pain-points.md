...
- Load: `{project-root}/.nexus/method/workflows/1-analysis/research/market-steps/step-04-customer-decisions.md`
...
After user selects 'C', load `{project-root}/.nexus/method/workflows/1-analysis/research/market-steps/step-04-customer-decisions.md` to analyze customer decision processes, journey mapping, and decision factors for {{research_topic}}.
