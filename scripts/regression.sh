...
# TASK-0035E10: SIP abuse protection (Fail2ban filters/jails/firewall action).
run_suite "sip-abuse-protection" "sip-abuse-protection-smoke-test.sh"
...
# TASK-0026F: placed right after pjsip-config-security and before
# authorization -- same reasoning as sql-security/shell-security/
# pjsip-config-security's own placement (an independent trust-boundary
...
# TASK-0035E5 / I8: restore runtime topology preservation (static + resolver).
run_suite "restore-runtime-topology" "restore-runtime-topology-smoke-test.sh"
...
# TASK-0034I-R4: queue runtime (queues.conf / app_queue) + AMI
...
# TASK-0034I-R7: global front-controller / base-URL contract + route create/duplicate.
run_suite "global-url-basepath-smoke" "global-url-basepath-smoke-test.sh"
