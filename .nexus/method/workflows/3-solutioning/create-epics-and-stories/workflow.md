...
Read fully and follow: `{project-root}/.nexus/method/workflows/3-solutioning/create-epics-and-stories/steps/step-01-validate-prerequisites.md` to begin the workflow.
