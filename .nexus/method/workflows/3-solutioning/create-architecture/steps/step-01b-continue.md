...
- Example: If `stepsCompleted: [1, 2, 3]`, load `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
...
- If confirmed: Delete existing document and read fully and follow: `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-01-init.md`
...
- `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-02-context.md`
- `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-03-starter.md`
- `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
- `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-05-patterns.md`
- `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-06-structure.md`
- `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-07-validation.md`
- `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-08-complete.md`
