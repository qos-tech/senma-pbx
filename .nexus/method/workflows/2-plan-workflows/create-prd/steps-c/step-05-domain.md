...
# File References
nextStepFile: '{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/steps-c/step-06-innovation.md'
outputFile: '{docs_dir}/prd.md'
domainComplexityCSV: '{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/data/domain-complexity.csv'
