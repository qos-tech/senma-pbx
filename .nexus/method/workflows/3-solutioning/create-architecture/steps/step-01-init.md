...
- Look for existing `{docs_dir}/*architecture*.md`
...
- **STOP here** and load `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-01b-continue.md` immediately
...
Copy the template from `{installed_path}/architecture-decision-template.md` to `{docs_dir}/architecture.md`
...
- Created: `{docs_dir}/architecture.md` from template
...
After user selects [C] to continue, only after ensuring all the template output has been created, then load `{project-root}/.nexus/method/workflows/3-solutioning/create-architecture/steps/step-02-context.md` to analyze the project context and begin architectural decision making.
