...
- Search `{docs_dir}` for files matching `*prd*.md`
- Also check for sharded PRDs: `{docs_dir}/*prd*/*.md`
...
**If NO PRDs found:**
- "I couldn't find any PRD files in {docs_dir}. Please provide the path to the PRD file you want to validate."
