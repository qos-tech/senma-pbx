...
- Look for `{docs_dir}/architecture.md`
...
After user selects [C] to continue, load `{project-root}/.nexus/method/workflows/generate-project-context/steps/step-02-generate.md` to collaboratively generate the specific project context rules.
