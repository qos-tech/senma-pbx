...
Load and read full config from {project-root}/.nexus/project.yaml and resolve:

- `project_name`, `output_folder`, `user_name`, `communication_language`, `document_output_language`, `user_skill_level`

The planning artifacts folder is `{docs_dir}`, which the runner resolves to this feature's folder.

### 2. First Step EXECUTION

Read fully and follow: `{project-root}/.nexus/method/workflows/1-analysis/create-product-brief/steps/step-01-init.md` to begin the workflow.
