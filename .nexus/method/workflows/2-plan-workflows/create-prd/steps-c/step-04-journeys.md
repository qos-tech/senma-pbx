...
# File References
nextStepFile: '{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/steps-c/step-05-domain.md'
...
After user selects 'C' and content is saved to document, load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-prd/steps-c/step-05-domain.md`.
