...
- IF C: Load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-ux-design/steps/step-07-defining-experience.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.nexus/method/workflows/2-plan-workflows/create-ux-design/steps/step-07-defining-experience.md` to define the core user interaction.
