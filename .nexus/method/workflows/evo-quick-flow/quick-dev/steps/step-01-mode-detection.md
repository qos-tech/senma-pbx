...
- `{tech_spec_path}` - Path to the spec file (if Mode A). A spec is a story: it lives under `{project-root}/.nexus/specs/{active_issue}/`.
...
- **NEXT:** Read fully and follow: `{project-root}/.nexus/method/workflows/evo-quick-flow/quick-dev/steps/step-03-execute.md`
...
- IF E: Ask for any additional guidance, then **NEXT:** Read fully and follow: `{project-root}/.nexus/method/workflows/evo-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
- IF E: Ask for guidance, then **NEXT:** Read fully and follow: `{project-root}/.nexus/method/workflows/evo-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
- Mode A (tech-spec): "**NEXT:** read fully and follow: `{project-root}/.nexus/method/workflows/evo-quick-flow/quick-dev/steps/step-03-execute.md`"
- Mode B (direct, [E] selected): "**NEXT:** Read fully and follow: `{project-root}/.nexus/method/workflows/evo-quick-flow/quick-dev/steps/step-02-context-gathering.md`"
