...
- Load: `{project-root}/.nexus/method/workflows/1-analysis/research/technical-steps/step-03-integration-patterns.md`
...
After user selects 'C', load `{project-root}/.nexus/method/workflows/1-analysis/research/technical-steps/step-03-integration-patterns.md` to analyze APIs, communication protocols, and system interoperability for {{research_topic}}.
